...
test.csv and train.csv are the dataset fromthe Kaggle competition (https://www.kaggle.com/c/bike-sharing-demand/overview). BikeSharingRcode.R include what Professor Heaton did in class to help us start off this competition. Bikesharing-SelfCode.R is my best submission for this Kaggle competition which recieved a score of 0.66538. 
